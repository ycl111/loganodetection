...
if __name__ == '__main__':
    ...
    parser.add_argument('-word_model', help='word_model', type=str, default='../../model/kafka_log.model')
    parser.add_argument('-template_vector_file', help='template_vector_file', type=str, default='../../model/kafka_log.template_vector')
