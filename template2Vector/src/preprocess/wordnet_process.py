...
if __name__ == '__main__':
    ...
    parser.add_argument('-template_file', help = 'template_file', type = str, default = 'kafka_log.template')
    parser.add_argument('-syn_file',help = 'syn_file', type = str, default = 'kafka_log.syn')
    parser.add_argument('-ant_file',help = 'ant_file', type = str, default = 'kafka_log.ant')
